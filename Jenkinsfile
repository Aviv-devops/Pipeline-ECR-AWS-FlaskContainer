        ...
        stage("Connect and docker pull") {
            steps{
                sshagent(credentials:['devops']) {
                    sh 'ssh -T ubuntu@54.83.199.231 "docker pull 808447716657.dkr.ecr.us-east-1.amazonaws.com/flask_image:latest && docker run -itd 808447716657.dkr.ecr.us-east-1.amazonaws.com/flask_image:latest"'
                }
            }
        }
